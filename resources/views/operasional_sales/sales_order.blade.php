                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="#" class="btn btn-primary d-none d-sm-inline-block" data-bs-toggle="modal"
                            data-bs-target="#modal-create-so">
        ...
        <div class="container-xl">
            ...
            <div class="row row-cards mb-3">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Sales Order per Status</h3>
                        </div>
                        <div class="card-body">
                            <div id="chart-sales-order-status" style="height: 200px;">
                                {{-- Placeholder for a chart (e.g., Pie Chart) --}}
                                {{-- <p class="text-center text-muted py-5">Grafik status Sales Order akan ditampilkan di sini.<br>Contoh: Pie Chart (Pending ACC, ACC, Terkirim, Ditolak)</p> --}}
                                <canvas id="soStatusChart"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Total Penjualan Bulanan</h3>
                        </div>
                        <div class="card-body">
                            <div id="chart-monthly-sales" style="height: 200px;">
                                {{-- Placeholder for a chart (e.g., Bar/Line Chart) --}}
                                {{-- <p class="text-center text-muted py-5">Grafik total penjualan bulanan akan ditampilkan di --}}
                                {{-- sini.<br>Contoh: Bar Chart (Jan, Feb, Mar, ...)</p> --}}
                        ...
                        <table id="salesOrderTable" class="table table-vcenter card-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <a href="{{ route('operasional_sales.sales_order_detail', ['id' => 'SO001']) }}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('operasional_sales.sales_order_detail', ['id' => 'SO002']) }}"
                                            class="btn btn-info btn-sm">Detail</a>
                                ...
                                <tr>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <a href="{{ route('operasional_sales.sales_order_detail', ['id' => 'SO003']) }}"
                                            class="btn btn-info btn-sm">Detail</a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('operasional_sales.sales_order_detail', ['id' => 'SO004']) }}"
                                            class="btn btn-info btn-sm">Detail</a>
                                    </td>
                                </tr>
                            </tbody>
                ...
                <div class="modal-body">
                    <form action="#" method="POST">
                        ...
                        <div id="product-list">
                            <div class="row mb-3 product-item">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="products[0][price]" value="100000"
                                        readonly>
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="bonus_produk"
                                placeholder="Contoh: Beli 6 gratis 1 (Reguler)">
                            <small class="form-hint">Misalnya, bonus reguler, program, atau khusus.</small>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Diskon Penjualan</label>
                            <input type="text" class="form-control" name="diskon_penjualan"
                                placeholder="Contoh: 10% (Reguler)">
    ...
    @push('scripts')
        <script>
            ...
            `;
                ...
                const soStatusCtx = document.getElementById('soStatusChart').getContext('2d');
                new Chart(soStatusCtx, {
                    type: 'pie',
                    data: {
                        labels: ['Pending ACC', 'ACC', 'Terkirim', 'Ditolak'],
                        datasets: [{
                            data: [5, 12, 30, 3], // Contoh data
                ...
                new Chart(monthlySalesCtx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            data: [10, 15, 20, 12, 25, 18, 22], // Contoh data
