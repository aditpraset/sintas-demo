        ...
        <div class="row row-cards">
            <div class="col-12">
                <div class="alert alert-success" role="alert">
                    <h4 class="alert-title">Selamat Datang, Koperasi!</h4>
                ...
                <div class="card card-sm">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <div class="font-weight-medium">
                                    Anggota Dalam Proses Verifikasi
                                </div>
                                <div class="text-secondary">
                                    5 Anggota
                                </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Pendaftaran Anggota Baru</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Status Anggota Baru</h3>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <span class="badge bg-danger me-1"></span> 3 Anggota mendaftar hari ini.
                            </li>
                            <li class="list-group-item">
                                <span class="badge bg-warning me-1"></span> 2 Anggota Ditolak.
                            </li>
                            <!-- <li class="list-group-item">
    ...
    $(document).ready(function() {
        ...
        new Chart(overallSalesTrendCtx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Anggota',
                    data: [2, 3, 1, 2, 3, 2, 3, 4, 3, 4, 5, 6], // Contoh data
                    borderColor: '#007bff',
