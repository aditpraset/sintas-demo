        ...
        <div class="row row-cards">
            <div class="col-12">
                <div class="alert alert-info" role="alert">
                    <h4 class="alert-title">Selamat Datang, RPK Kecil A!</h4>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Pencapaian Penjualan Mingguan</h3>
                    </div>
                    <div class="card-body">
